...
st.markdown("* Pos - posição do jogador")
...
st.markdown("* 2P - cestas de 2 pontos por jogos")
st.markdown("* 2PA - tentativa de arremessos de 2 pontos")
st.markdown("* 2P% - porcentagem de acertos dos arremessos de 2 pontos")
